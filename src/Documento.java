...
public class Documento {
    ...
    public static ArbolBinario getArbolBinario(int criterio) {
        ...
        for (Documento d : documentos) {
            Documento dUpper = new Documento(
                    d.getApellido1().toUpperCase(),
                    d.getApellido2().toUpperCase(),
                    d.getNombre().toUpperCase(),
                    d.getDocumento().toUpperCase());
            ab.agregarNodo(new Nodo(dUpper));
        }
        return ab;
    }
